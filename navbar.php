...
<body class="container-fluid ">
        ...
        <div class="col-4 nav3">
            ...
            <ul class="navbar-nav " style="display: flex; flex-direction: row; justify-content: end;">
                ...
                <li class="nav-item mx-2 hideMobile">
                    ...
                    if (isset($_SESSION["e"])) {
                    ?>
                        <button class="nav-link text-dark h5 me-3"><img src="Image/icon/icons8-logout-32 (1).png" alt="" class="ms-2 d-block" onclick="signOut();" id="so"></button>
                    <?php
                    } else {
                    ?>
                ...
                <li class="nav-item mx-2 me-2 menubar" onclick="showSidebar();">
                    <a style="cursor: pointer;" class="nav-link text-dark h5 me-3" target="blank"><img src="Image/icon/icons8-menu-16.png" height="30px" alt=""></a>
                </li>
    ...
    <!-- side bar  -->
    <ul class="sidebar ">
    <li class="nav-item mx-2 me-2 mt-3 " onclick="hideSidbar();">
                    <a style="cursor: pointer;" class="nav-link text-dark h5 me-3" target="blank"><img src="Image/icon/icons8-close-16.png" height="30px" alt=""></a>
                </li>
        <li style="text-decoration: none;" class="mt-2 "><a style="text-decoration: none; color: white;" href="index.php">Home</a></li>
        <li class="mt-2 "><a style="text-decoration: none; color: white;"  href="products.php">Products</a></li>
        <li class="mt-2 "><a style="text-decoration: none; color: white;" href="orderHistory.php">Order History</a></li>
        <li class="mt-2 "><a style="text-decoration: none; color: white;" class="nav-link text-dark h5 me-3" href="cart.php" target="blank"><img src="Image/icon/cart.png" alt=""></a></li>
        <li class="mt-2 "><a style="text-decoration: none; color: white;" class="nav-link text-dark h5 me-3" href="whichlist.php" target="blank"><img src="Image/icon/heart.png" alt=""></a></li>

        <li class="nav-item mx-2 mt-2">
                    <?php
                    if (isset($_SESSION["e"])) {
                    ?>
                        <button class="nav-link text-dark h5 me-3"><img src="Image/icon/icons8-logout-32 (1).png" alt="" class=" d-block" onclick="signOut();" id="so"></button>
                    <?php
                    } else {
                    ?>
                        <button class="nav-link text-dark h5"><img src="Image/icon/icons8-logout-32 (1).png" alt="" class=" d-none" onclick="signOut();" id="so"></button>
                    <?php
                    }
