...
if (empty($fname)) {
    ...
    if ($num > 0) {
        echo ("Your Email OR Username OR Mobile Already Exist");
    } else {
        Database::iud("INSERT INTO `user` (`fName`,`lName`,`email`,`mobile`, `password`,`user_type_id`)
        VALUES ('".$fname."','".$lname."','".$email."','".$mobile."','".$password."','2')");
        echo ("Success");
    }
}
